...
function AsyncAPIServers() {
    ...
    useEffect(() => {
        async function parseDefinition() {
            ...
            const doc = await parse(api.apiDefinition);
            if (doc.hasServers()) {
                                        ...
                                        <>
                                            ...
                                            <Grid item spacing={2} xs={12}>
                                                <Grid container spacing={2} xs={12}>
                                                    ...
                                                    <Grid item>
                                                        <Chip
                                                            label={upperCaseString(servers[server].protocol)}
                                                            color='primary'
                                                        />
                                                    </Grid>
                                                    <Grid
...
export default AsyncAPIServers;
